...
public final class BotMessages {
    ...
    static {
        M.put(Language.EN, Map.<String, String>ofEntries(
                ...
                Map.entry("no_team", "⚠️ You are not in a team yet. Open the web app and either join a team or create your own."),
                Map.entry("join_req_new", "📥 %s wants to join %s."),
                Map.entry("join_req_approved", "✅ Your request to join the team was approved."),
                Map.entry("join_req_rejected", "❌ Your request to join the team was rejected."),
                Map.entry("join_req_pending", "📥 Join requests"),
                Map.entry("join_req_approved_done", "✅ You approved %s's request to join."),
                Map.entry("join_req_rejected_done", "❌ You rejected %s's request to join."),
                Map.entry("join_req_gone", "⚠️ This join request was already handled."),
                Map.entry("join_req_forbidden", "🚫 You are not allowed to decide this request."),
                Map.entry("btn_join_reject", "❌ Reject"),
                ...
                Map.entry("notif_proposed", "📝 %s reported a task to confirm: %s"),
                Map.entry("proposal_new", "📝 New task to confirm"),
                Map.entry("proposed_by", "Proposed by"),
                Map.entry("btn_details", "👁 Details"),
                Map.entry("proposal_approved_done", "✅ You confirmed %s's task."),
                Map.entry("proposal_rejected_done", "❌ You declined %s's task."),
                Map.entry("proposal_gone", "⚠️ This proposal was already handled."),
                Map.entry("proposal_forbidden", "🚫 You are not allowed to decide this proposal."),
                Map.entry("notif_proposal_confirmed", "✅ %s confirmed your task: %s"),
                Map.entry("notif_proposal_declined", "❌ %s declined your task: %s"),
                Map.entry("notif_ticket_reply", "💬 Support replied to your ticket: %s"),
                Map.entry("notif_ticket_status", "🎫 Your ticket is now %s: %s"),
                Map.entry("notif_ticket_new", "🎫 New support ticket: %s — %s"),
                Map.entry("notif_ticket_msg", "💬 %s wrote on a ticket: %s"),
                ...
                Map.entry("notif_comment", "💬 %s commented on %s:\n\n%s\n\n↩️ Reply to this message to answer."),
        ...
        M.put(Language.RU, Map.<String, String>ofEntries(
                ...
                Map.entry("no_team", "⚠️ Вы ещё не состоите в команде. Откройте веб-приложение и либо присоединитесь к команде, либо создайте свою."),
                Map.entry("join_req_new", "📥 %s хочет присоединиться к «%s»."),
                Map.entry("join_req_approved", "✅ Ваш запрос на вступление в команду одобрен."),
                Map.entry("join_req_rejected", "❌ Ваш запрос на вступление в команду отклонён."),
                Map.entry("join_req_pending", "📥 Запросы на вступление"),
                Map.entry("join_req_approved_done", "✅ Вы одобрили запрос %s на вступление."),
                Map.entry("join_req_rejected_done", "❌ Вы отклонили запрос %s на вступление."),
                Map.entry("join_req_gone", "⚠️ Этот запрос уже обработан."),
                Map.entry("join_req_forbidden", "🚫 У вас нет прав решать по этому запросу."),
                Map.entry("btn_join_reject", "❌ Отклонить"),
                ...
                Map.entry("notif_proposed", "📝 %s предложил(а) задачу на подтверждение: %s"),
                Map.entry("proposal_new", "📝 Новая задача на подтверждение"),
                Map.entry("proposed_by", "Предложил(а)"),
                Map.entry("btn_details", "👁 Подробнее"),
                Map.entry("proposal_approved_done", "✅ Вы подтвердили задачу от %s."),
                Map.entry("proposal_rejected_done", "❌ Вы отклонили задачу от %s."),
                Map.entry("proposal_gone", "⚠️ Это предложение уже обработано."),
                Map.entry("proposal_forbidden", "🚫 У вас нет прав решать по этому предложению."),
                Map.entry("notif_proposal_confirmed", "✅ %s подтвердил(а) вашу задачу: %s"),
                Map.entry("notif_proposal_declined", "❌ %s отклонил(а) вашу задачу: %s"),
                Map.entry("notif_ticket_reply", "💬 Поддержка ответила на ваш тикет: %s"),
                Map.entry("notif_ticket_status", "🎫 Статус вашего тикета: %s — %s"),
                Map.entry("notif_ticket_new", "🎫 Новый тикет: %s — %s"),
                Map.entry("notif_ticket_msg", "💬 %s написал(а) в тикете: %s"),
                ...
                Map.entry("notif_mentioned", "💬 %s упомянул(а) вас в %s:\n\n%s\n\n↩️ Ответьте на это сообщение, чтобы написать комментарий."),
                Map.entry("notif_comment", "💬 %s оставил(а) комментарий к %s:\n\n%s\n\n↩️ Ответьте на это сообщение, чтобы написать комментарий."),
        ...
        M.put(Language.UZ, Map.<String, String>ofEntries(
                ...
                Map.entry("no_team", "⚠️ Siz hali jamoada emassiz. Web-ilovani ochib jamoaga qo'shiling yoki o'zingiznikini yarating."),
                Map.entry("join_req_new", "📥 %s «%s» jamoasiga qo'shilmoqchi."),
                Map.entry("join_req_approved", "✅ Jamoaga qo'shilish so'rovingiz tasdiqlandi."),
                Map.entry("join_req_rejected", "❌ Jamoaga qo'shilish so'rovingiz rad etildi."),
                Map.entry("join_req_pending", "📥 Qo'shilish so'rovlari"),
                Map.entry("join_req_approved_done", "✅ %s ning qo'shilish so'rovini tasdiqladingiz."),
                Map.entry("join_req_rejected_done", "❌ %s ning qo'shilish so'rovini rad etdingiz."),
                Map.entry("join_req_gone", "⚠️ Bu so'rov allaqachon ko'rib chiqilgan."),
                Map.entry("join_req_forbidden", "🚫 Bu so'rovni hal qilishga ruxsatingiz yo'q."),
                Map.entry("btn_join_reject", "❌ Rad etish"),
                ...
                Map.entry("notif_mentioned", "💬 %s sizni %s da eslatdi:\n\n%s\n\n↩️ Javob yozish uchun shu xabarga reply qiling."),
                Map.entry("notif_comment", "💬 %s %s taskiga izoh yozdi:\n\n%s\n\n↩️ Javob yozish uchun shu xabarga reply qiling."),
                ...
                Map.entry("notif_proposed", "📝 %s tasdiqlash uchun task taklif qildi: %s"),
                Map.entry("proposal_new", "📝 Tasdiqlash uchun yangi task"),
                Map.entry("proposed_by", "Taklif qildi"),
                Map.entry("btn_details", "👁 Batafsil"),
                Map.entry("proposal_approved_done", "✅ %s ning taskini tasdiqladingiz."),
                Map.entry("proposal_rejected_done", "❌ %s ning taskini rad etdingiz."),
                Map.entry("proposal_gone", "⚠️ Bu taklif allaqachon ko'rib chiqilgan."),
                Map.entry("proposal_forbidden", "🚫 Bu taklifni hal qilishga ruxsatingiz yo'q."),
                Map.entry("notif_proposal_confirmed", "✅ %s taskingizni tasdiqladi: %s"),
                Map.entry("notif_proposal_declined", "❌ %s taskingizni rad etdi: %s"),
                Map.entry("notif_ticket_reply", "💬 Support ticketingizga javob berdi: %s"),
                Map.entry("notif_ticket_status", "🎫 Ticketingiz holati: %s — %s"),
                Map.entry("notif_ticket_new", "🎫 Yangi ticket: %s — %s"),
                Map.entry("notif_ticket_msg", "💬 %s ticketga xabar yozdi: %s"),
